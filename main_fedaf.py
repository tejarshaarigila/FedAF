...
class ARGS:
    def __init__(self):
        ...
        self.logits_dir = '/home/logits'
        self.save_image_dir = '/home/images'
        self.save_path = '/home/result'
        ...
        self.model_dir = f'/home//models/{self.dataset}/{self.model}/{self.num_partitions}/{self.honesty_ratio}'
